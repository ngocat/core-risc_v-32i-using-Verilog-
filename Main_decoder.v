module main_decoder(
   input [6:0] opcode,
	...
	output [2:0]ImmSrc
	 ...
	 reg [13:0] controls;
	 always @(*) begin
		 controls = 14'b0___000_0____00______0____00______0_______0_____00; //
		 case (opcode)
											 //reg/imm/mem/result/branch/aluop/alusource/jump/second
			7'b0000011: controls = 14'b1___000_0____01______0____00______1_______0_____xx; // i
			7'b0010011: begin 
								case(funct3)
									3'b001: begin
									controls = (funct7==7'b0000000)? 
											14'b1___000_0____00______0____10______1_______0_____xx:
											14'b0___000_0____00______0____10______1_______0_____xx; // i_alu  slli f7b5=0
											end
									3'b101: begin
									controls = ((funct7==7'b0000000) | (funct7==7'b0100000))?
											14'b1___000_0____00______0____10______1_______0_____xx: //			srli f7b5=0
											14'b0___000_0____00______0____10______1_______0_____xx; // i_alu_ srai f7b5=1
											end
			...
			//u
			7'b0110111: controls = 14'b1___100_0____11______0____xx______x_______0_____01; //lui
			7'b0010111: controls = 14'b1___100_0____11______0____xx______x_______0_____01; //auipc
			default controls = 14'b0___000_0____00______0____00______0_______0_____00; //
		endcase
	end
